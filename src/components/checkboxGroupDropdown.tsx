        ...
        {({ open }) => (
          <div>
            ...
            <Transition show={open || isActive}>
              <Menu.Items
                as='div'
                className={`absolute max-h-[35vh] ${inputName === 'jobTitle' ? ' w-[30vw]' : 'w-full'} min-w-[120px] overflow-y-auto  overflow-x-hidden whitespace-nowrap  z-20 mt-2 rounded-md  bg-white py-4 shadow-lg ring-1 ring-black ring-opacity-5`}
              >
